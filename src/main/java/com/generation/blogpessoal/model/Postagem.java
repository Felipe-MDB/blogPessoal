...
public class Postagem {
	...
	@Id  // Difini a chave primaria
	@GeneratedValue(strategy = GenerationType.IDENTITY) // Defini que o campo é preenchido pelo banco (generatedValue) | como é preenchido, de forma inclemental (generationType)
	...
	// título varchar(100) NOT NULL | ["título"]
	...
	private LocalDateTime data;  // estamos pedindo a data que foi cadastrada a postagem e atualizada
